...
```bash
git remote add encore encore://solana-token-creator-4us2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/solana-token-creator-4us2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/solana-token-creator-4us2/settings/integrations/github)
