...
CREATE INDEX idx_token_transfers_mint_address ON token_transfers(mint_address);
...
CREATE INDEX idx_token_transfers_signature ON token_transfers(transaction_signature);
CREATE INDEX idx_token_transfers_created_at ON token_transfers(created_at DESC);

-- Create compound indexes for common queries
CREATE INDEX idx_token_transfers_from_to ON token_transfers(from_address, to_address);
CREATE INDEX idx_token_transfers_wallet_lookup ON token_transfers(from_address, to_address, created_at DESC);
